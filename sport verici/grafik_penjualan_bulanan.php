...
<tr><th colspan=3>Penjulanan Perhari  Pada Bulan : <?php echo "$_POST[bulan]"; ?> / <?php echo "$_POST[tahun]"; ?>-</th></tr>
<tr>
...
<body>
	...
	$('#myChart1Container').insertFusionCharts({
		...
		height: "400",		
		type: "Column3D",
		data: "data_penjualan_bulanan.php?bln=<?php echo"$_POST[bulan]"; ?>&thn=<?php echo"$_POST[tahun]"; ?>",
		dataFormat: "URIData"
	});
	</script>
	</center>
