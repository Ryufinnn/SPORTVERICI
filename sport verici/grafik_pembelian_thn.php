...
<tr><th colspan=3>Pembeliann Per-Bulan Pada Tahun  : <?php echo "$_POST[tahun]"; ?></th></tr>
<tr>
...
<center><h2>Pembelian Tahun : <?php echo "$_POST[tahun]"; ?></h2></center>
...
<body>
	...
	$('#myChart1Container').insertFusionCharts({
		...
		height: "400",		
		type: "Column3D",
		data: "data_pembelian_thn.php?thn=<?php echo"$_POST[tahun]"; ?>",
		dataFormat: "URIData"
	});
	</script>
	</center>
