...
<td><input name="cari" type="button" onclick='this.form.submit()' value="cari"></td></tr>
			...
			<center>
			<a href='cetak_pendapatan_perbulan.php?tahun=<?php echo $_POST['tahun']?>&bulan=<?php echo $_POST['bulan']?>'target=_blank><font color=red><b><u>Cetak</u> </b></font><img src="./images/cetak.png" height=15></a>
			<hr></hr>
			<table border=1  id="table-a" align=center>
					<tr bgcolor=#34a5cf>
						<th>No.</th>
