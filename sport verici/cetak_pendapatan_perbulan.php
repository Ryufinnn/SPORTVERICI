...
<tr><th><font size=2>Pendapatan Bulan : <?php echo "$nm_bulan[$bulan] - $tahun"; ?></font></th></tr>
...
echo "<tr>";
echo "<td colspan=2 <b>Total Penjualan bulan : $nm_bulan[$bulan]-$tahun </b></td>";
echo "<th><font>Rp. ";
