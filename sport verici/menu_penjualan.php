	...
	<div class="container_12 clearfix">
		<div class="grid_12">
			<ul id="mainmenu" class="sf-menu">
				<li <?php if($_GET[module]=="home" || $_GET[module]=="" ) { echo "class='current'"; } ?>><a href="menu_penjualan.php">Beranda</a></li>
				
					<li <?php if($_GET[module]=="laporan" || $_GET[module]=="laporan" ) { echo "class='current'"; } ?>><a href="#">Laporan Penjualan</a>
					<ul>
					<li><a href="?module=laphari">Penjualan Bulanan</a></li>
				...
				<li <?php if($_GET[module]=="jual_sales") { echo "class='current'"; } ?>><a href="?module=jual_sales">Penjualan </a></li>
		...
		<section id="main" class="grid_10">
			<article id="dashboard">
                           ...
                           <?php 
							...
							echo "<div class='information msg'>Hai <b>$_SESSION[namalengkap]</b>, Selamat datang SuperVisor</div>";
					}
							if ($_GET['module']=="pelanggan"){include "form_pelanggan.php";}
							if ($_GET['module']=="ubahpelanggan"){include "ubah_pelanggan.php";}
							
							if ($_GET['module']=="jual_sales"){include "penjualan_sales.php";}
							if ($_GET['module']=="informasi"){include "informasi_stok1.php";}
							if ($_GET['module']=="editpenjualan"){include "editpenjualan.php";}
					
									if ($_GET['module']=="sales"){include "form_sales.php";}
									if ($_GET['module']=="ubahsales"){include "ubah_sales.php";}
