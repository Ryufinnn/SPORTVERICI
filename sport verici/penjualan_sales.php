...
<form name="form1" method="post" action="">
  ...
  <table width="100%" border="0" cellspacing="6" cellpadding="6" bgcolor="#dedede">
    <tr>
      <td width="13%" align="left" valign="top">No. Faktur  
	  </td>
      <td width="28%" align="left" valign="top"><label for="b8"></label>
	  
    <p> <input type="text" name="b1" id="b1" class="tb6" value="<?php include "./generate_kode.php"; echo get_new_id("no_faktur","penjualan","P-"); ?>" />
        <input type="button" name="button2" onclick=location.href='menu_penjualan.php?module=editpenjualan' id="cari" value="Cari Faktur"  class="button blue"/></p></td>
...
if($_POST[button2])
{
	if($_POST[b4]=="" )
	{
		...
		if($trow==0)
		{
			...
			{
				$qdp="Insert into penjualan values ('".$_POST[b1]."','".$_POST[b4]."','".$rowt['kd_barang']."','".$rowt['jml']."')";
...
include "Config/Connect.php";
	  $q="SELECT * FROM penjualan where no_faktur='$_GET[idjual]' ORDER BY no_faktur";
	  $res=mysql_query($q) or die(mysql_error());
